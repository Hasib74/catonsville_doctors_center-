...
import 'date-utails.dart';
import 'date-utails.dart' as dateUtails;
...
class CalendarStripState extends State<CalendarStrip>
  ...
  TextStyle selectedDateStyle = TextStyle(
      fontSize: 17, fontWeight: FontWeight.w800, color: AppColors.primaryColor);
  ...
  CalendarStripState(
    ...
    lastDayOfMonth = dateUtails.DateUtils.getLastDayOfMonth(currentDate);
  ...
  int getLastDayOfMonth(rowStartingDay) {
    return dateUtails.DateUtils.getLastDayOfMonth(
